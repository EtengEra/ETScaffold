  ...
  <Dropdown placement="bottomLeft" :overlayClassName="`${prefixCls}-dropdown-overlay`">
    ...
    <template #overlay>
      <Menu @click="handleMenuClick">
        ...
        <MenuItem key="depart" :text="t('layout.header.dropdownItemSwitchDepart')" icon="ant-design:cluster-outlined" v-if="!(getUserInfo.devFlag)"/>
...
<script lang="ts">
  ...
  type MenuEvent = 'logout' | 'doc' | 'lock' | 'cache' | 'depart' | 'password' | 'account' ;
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const getUserInfo = computed(() => {
        const { realname = '', avatar, desc, devFlag } = userStore.getUserInfo || {};
        return { realname, avatar: avatar || headerImg, desc, devFlag };
      });
