...
interface BasicStore {
  ...
  [ID_TOKEN_KEY]: string | number | null | undefined;
...
window.addEventListener('beforeunload', function () {
  ...
  ls.set(APP_LOCAL_CACHE_KEY, {
    ...
    ...pick(ls.get(APP_LOCAL_CACHE_KEY), [TOKEN_KEY, ID_TOKEN_KEY, USER_INFO_KEY, LOCK_INFO_KEY]),
  });
  ss.set(APP_SESSION_CACHE_KEY, {
    ...omit(sessionMemory.getCache, LOCK_INFO_KEY),
    ...pick(ss.get(APP_SESSION_CACHE_KEY), [TOKEN_KEY, ID_TOKEN_KEY, USER_INFO_KEY, LOCK_INFO_KEY]),
  });
});
