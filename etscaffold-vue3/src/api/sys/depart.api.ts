...
export enum Api {
  ...
  getDeptRole = '/sys/sysDepart/queryDeptRole',
  queryTreeListByDepartParentId = '/sys/role/queryTreeListByParams',
}
 ...
 * @param params
 */
export const getDeptRoles = (params) => defHttp.get({ url: Api.getDeptRole, params }, { errorMessageMode: 'none' });
 ...
 * 根据部门父id获取权限树列表
 */
export const queryTreeListByDepartParentId = (params?) => defHttp.get({ url: Api.queryTreeListByDepartParentId, params });
