package cn.etena.common.constant;
...
public interface CommonConstant {
     ...
     * 通用值 0
     */
    Integer UNIVERSAL_VALUE_ZERO = 0;
     ...
     * 开发者
     */
    String IS_DEVELOPER = "1";

   /**
    *  开发者用户组 id
    */
    String OPS_USER_GROUP_ID = "1671434290456662018";
 ...
 /** {@code 500 Server Error} (HTTP/1.0 - RFC 1945) */
    ...
    /** 登录用户Shiro权限缓存KEY前缀 */
    public static String PREFIX_USER_SHIRO_CACHE  = "shiro:cache:cn.etena.config.shiro.ShiroRealm.authorizationCache:";
    /** 登录用户Token令牌缓存KEY前缀 */
...
//    int  TOKEN_EXPIRE_TIME  = 3600;
    ...
    /** 超级管理员 租户id**/
    String SUPER_ADMIN_TENANT_ID = "99999";

    /** 超级管理员 账号**/
    String SUPER_ADMIN = "admin";

    /** 系统默认租户id **/
    String DEFAULT_VALUE = "99999";

    /** 应用系统id **/
    String APPLICATION_ID = "X-Application-Id";
  ...
  * 表单设计器主表类型
    ...
    /**
     * nacos 配置 删除，添加，编辑操作 成功和失败提示信息
     */
    String DELETE_OPERATE_SUCCESS= "删除成功";
    String DELETE_OPERATE_FAIL= "删除失败";
    String ADD_OPERATE_SUCCESS= "添加成功";
    String ADD_OPERATE_FAIL= "添加失败";
    String EDIT_OPERATE_SUCCESS= "编辑成功";
    String EDIT_OPERATE_FAIL= "编辑失败";
    /**
     * nacos 的请求参数
     */
    String SHOW_ALL = "all";
    ...
    /**
     * nacos 配置添加dataId已存在提示信息
     */
    String DATA_ID_EXISTS = "配置已存在, 试试别的dataId和group的组合吧";
}
